    ...
    <footer className="bg-gray-900 text-gray-200 py-8 p-3">
      <div className="container mx-auto flex flex-col md:flex-row justify-between">
        <div className="mb-4 md:mb-0">
          ...
          <p className="mt-2">
            Your e-commerce store's mission statement or brief description.
          </p>
        </div>
        <div className="mb-4 md:mb-0">
        ...
        <div>
          ...
          <form className="mt-2">
            ...
            />
            <button className="mt-2 bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-600 focus:ring focus:ring-blue-300 focus:outline-none">
              Subscribe
            </button>
          </form>
        </div>
